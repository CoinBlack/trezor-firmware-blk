...
message SignTx {
    ...
    optional uint32 timestamp = 9;         // only for Peercoin and Blackcoin, transaction timestamp
...
message TransactionType {
    ...
    optional uint32 timestamp = 13;         // only for Peercoin and Blackcoin, transaction timestamp
